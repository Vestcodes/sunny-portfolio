      ...
      <div className="space-y-32">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="prose prose-invert prose-lg font-mono text-off-white/80">
              <p>
                We do not rely on legacy monoliths. Our applications are deployed to the edge utilizing Vercel and Next.js, ensuring sub-100ms global response times.
              </p>
              <p>
                Every commit triggers an immutable build pipeline. Infrastructure as Code (IaC) guarantees that our production environments are identical, reproducible, and self-healing.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="order-1 md:order-2 prose prose-invert prose-lg font-mono text-off-white/80">
              <p>
                Security is not an afterthought; it is baked into the foundation. We assume all networks are hostile. 
              </p>
              <p>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="prose prose-invert prose-lg font-mono text-off-white/80">
              <p>
                Human QA cannot scale with complex state machines. We inject deterministic testing suites directly into the pipeline.
              </p>
              <p>
